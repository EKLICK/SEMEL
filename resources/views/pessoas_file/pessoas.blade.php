                        ...
                        @foreach ($pessoaslist as $pessoa)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="tooltipped" data-position="top" data-tooltip="Lista de {{$pessoa->nome}}" href="{{Route('pessoas_turmas', $pessoa->id)}}"><i class="small material-icons" style="color: #039be5;">group</i></a>
