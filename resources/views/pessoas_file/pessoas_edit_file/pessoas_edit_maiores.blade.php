                    ...
                    <div class="row">
                        <div class="input-field col s3">
                            ...
                            <label>
                                <p>
                                    <label>
                                        <input value="M" name="sexo" type="radio" @if ($pessoa->sexo == 'M' || old('sexo') == 'M') checked @endif/>
                                        <span>Masculino</span>
                                    </label>
                                </p>
                                <p>
                                    <label>
                                        <input value="F" name="sexo" type="radio" @if ($pessoa->sexo == 'F' || old('sexosexo') == 'F') checked @endif/>
                                        <span>Feminino</span>
                                    </label>
                                </p>
                            </label>
                        ...
                        <div class="input-field col s3">
                            ...
                            <label>
                                <p>
                                    <label>
                                        <input value="Solteiro" name="estado_civil" type="radio" @if ($pessoa->estado_civil == 'Solteiro' || old('estado_civil') == 'Solteiro') checked @endif/>
                                        <span>Solteiro</span>
                                    </label>
                                </p>
                                <p>
                                    <label>
                                        <input value="Casado" name="estado_civil" type="radio" @if ($pessoa->estado_civil == 'Casado' || old('estado_civil') == 'Casado') checked @endif/>
                                        <span>Casado</span>
                                    </label>
                                </p>
                            </label>
                        ...
                        <div class="input-field col s3">
                            ...
                            <label>
                                <p>
                                    <label>
                                        <input value="1" name="mora_com_os_pais" type="radio" @if ($pessoa->mora_com_os_pais == 1 || old('mora_com_os_pais') == '1') checked @endif/>
                                        <span>Sim</span>
                                    </label>
                                </p>
                                <p>
                                    <label>
                                        <input value="2" name="mora_com_os_pais" type="radio" @if ($pessoa->mora_com_os_pais == 2 || old('mora_com_os_pais') == '2') checked @endif/>
                                        <span>Não</span>
                                    </label>
                                </p>
                            </label>
