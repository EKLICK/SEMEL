            ...
            <form class="col s12" action="{{route('anamneses.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12 m6">
                        ...
                        <input id="string_cirurgia" name="string_cirurgia" type="text" class="validate" value="@if(is_null(old('cirurgia'))) @if($ultimaanamnese->cirurgia != -1) {{$ultimaanamnese->cirurgia}} @endif @else {{old('string_cirurgia')}} @endif" @if(!is_null(old('cirurgia'))) @if(old('cirurgia') == 2) hidden @endif @else @if ($ultimaanamnese->cirurgia == -1) hidden @endif @endif>
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12 m6">
                        ...
                        <input id="string_dor_ossea" name="string_dor_ossea" type="text" class="validate" value="@if(is_null(old('dor_ossea'))) @if($ultimaanamnese->dor_ossea != -1) {{$ultimaanamnese->dor_ossea}} @endif @else {{old('string_dor_ossea')}} @endif" @if(!is_null(old('dor_ossea'))) @if(old('dor_ossea') == 2) hidden @endif @else @if ($ultimaanamnese->dor_ossea == -1) hidden @endif @endif>
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12 m6">
                        ...
                        <input id="string_fumante" name="string_fumante" type="text" class="validate" value="@if(is_null(old('fumante'))) @if($ultimaanamnese->fumante != -1) {{$ultimaanamnese->fumante}} @endif @else {{old('string_fumante')}} @endif" @if(!is_null(old('fumante'))) @if(old('fumante') == 2) hidden @endif @else @if ($ultimaanamnese->fumante == -1) hidden @endif @endif>
