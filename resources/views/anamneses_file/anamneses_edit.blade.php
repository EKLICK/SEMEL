                    ...
                    <div class="row">
                        <div class="input-field col s3">
                            ...
                            <label>
                                <p>
                                    <label>
                                        <input value="1" name="atestado" type="radio" @if(!is_null(old('atestado'))) @if(old('atestado') == 1) checked @endif @else @if ($anamnese->atestado == 1) checked @endif @endif/>
                                        <span>Sim</span>
                                    </label>
                                </p>
                                <p>
                                    <label>
                                        <input value="2" name="atestado" type="radio" @if(!is_null(old('atestado'))) @if(old('atestado') == 2) checked @endif @else @if ($anamnese->atestado == 2) checked @endif @endif/>
                                        <span>Não</span>
                                    </label>
                                </p>
                            </label>
